      ...
      <section className="content-container1">
        ...
        <div className="text-container m-5">
          <div>
            ...
            </p><p className="custom-p" data-aos="fade-up" data-aos-duration="1300" data-aos-delay="500">
        ...
        <Container>
          ...
          <Row className="justify-content-center">
            <Col md={3} sm={6} xs={12}>
              <div className="featured-item text-center mb-4">
                <img src="https://www.rentanattire.com/assetsmain/img/home/Hanger.png" alt="Select a Style" />
                <div className="title text-uppercase">
                  <h4 className="font-cursive-bold  primaryDarkColor">Select a look</h4>
                </div>
                <div className="desc">
                  Find the clothes and accessories that match your style from our designer collection.                              </div>
              </div>
            </Col>
            <Col md={3} sm={6} xs={12}>
              <div className="featured-item text-center mb-4">
                <img src="https://www.rentanattire.com/assetsmain/img/home/book-your-outfit.png" alt="Book your Outfit" />
                <div className="title text-uppercase">
                  <h4 className="font-cursive-bold  primaryDarkColor">Confirm</h4>
                </div>
                <div className="desc">
            ...
            <Col md={3} sm={6} xs={12}>
              <div className="featured-item text-center mb-4">
                <img src="https://www.rentanattire.com/assetsmain/img/home/flaunt-it.png" alt="Flaunt It" />
                <div className="title text-uppercase">
                  <h4 className="font-cursive-bold  primaryDarkColor ">Show it off</h4>
                </div>
                <div className="desc">
            ...
            <Col md={3} sm={6} xs={12}>
              <div className="featured-item text-center mb-4">
                <img src="https://www.rentanattire.com/assetsmain/img/home/Freepickup.png" alt="Return It" />
                <div className="title text-uppercase">
                  <h4 className="font-cursive-bold  primaryDarkColor">Give it Back</h4>
                </div>
                <div className="desc">
          ...
          <Row className="justify-content-center">
            <Col xs={12} className="text-center">
              <img src="https://www.rentanattire.com/assetsmain/img/home/nos.png" style={{ maxWidth: '85%', marginTop: '-20px' }} className="steps" alt="Steps" />
            </Col>
          </Row>
        </Container>
      </section>
